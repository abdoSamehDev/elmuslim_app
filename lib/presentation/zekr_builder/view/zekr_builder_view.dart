...
class ZekrBuilderView extends StatelessWidget {
  ...
  final ZekrBuilderViewModel _viewModel = instance<ZekrBuilderViewModel>();
  ...
  Widget build(BuildContext context) {
    int count = 0;
    final List<AzkarModel> azkarFromCategory = _viewModel.getAzkarFromCategory(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        azkarFromCategory[index].description,
                        textAlign: TextAlign.center,
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(
                            height: AppSize.s1.h,
                            color: Theme.of(context).unselectedWidgetColor),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(AppPadding.p8.h),
                                child: Text(
                                  "$count/${azkarFromCategory[index].count.isEmpty ? "1" : azkarFromCategory[index].count}",
                                  textAlign: TextAlign.center,
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodySmall
